...
public class ordersHolder {
	...
	private static class DbHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE " + DATABASE_TABLE + " (" + KEY_ROWID
					...
					+ " varchar(25) NOT NULL , " + KEY_PRODUCTSTYPE
					+ " varchar(35) NOT NULL); ");
	...
	public void updateEntry(long lRowMod, String modifyName,
		...
		ourDatabase.update(DATABASE_TABLE, cvUpdate, KEY_ROWID + "=" + lRowMod,
				null);
	...
	//this will get all the info from the database
	for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()){
		allInfo.add(c.getString(iRow) +" \t\t\t "+ c.getString(iName) + " \t\t\t " + c.getString(iProduct)); 
	}
	return allInfo;
}
	/*public ArrayList<String> getAll()  throws SQLException{
