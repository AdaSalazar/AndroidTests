...
public class Warehouse extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ordersHolder autoComplete = new ordersHolder(Warehouse.this);
	...
	public void onClick(View arg0) {
		...
		case R.id.bUpdateSQL:
			...
			didItWork = true;
			try {
				ordersHolder entry = new ordersHolder(Warehouse.this);
				entry.open();
